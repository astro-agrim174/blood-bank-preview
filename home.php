...
<div class="hero w-100vw h-100vh flex flex-col">
          ...
          <div class="flex flex-wrap -m-4">
            <div class="p-4 md:w-1/3">
              <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="image/eligibility.jpeg" alt="blog">
                <div class="p-6">
            ...
            <div class="p-4 md:w-1/3">
              <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="image/benefits.jpeg" alt="blog">
                <div class="p-6">
                  <h1 class="title-font text-lg font-medium text-gray-900 mb-3">blood donation benefits</h1>
                  <p class="leading-relaxed mb-3">Some of the benefits you will be getting for doing this kind act.</p>
                  <div class="flex items-center flex-wrap">
                    <a class="text-[#E75B63] inline-flex items-center md:mb-2 lg:mb-0">Learn More
                      <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M5 12h14"></path>
            ...
            <div class="p-4 md:w-1/3">
              <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="image/procedures.jpeg" alt="blog">
                <div class="p-6">
      ...
      <section>
        ...
        <hr class="my-8 h- bg-red-700 dark:bg-gray-700">



        <span id="benefits" class="text-2xl font-bold text-black flex justify-center ">Blood Donation Benefits</span>
        <br>
        <p class=" leading-10 text-2xl ml-5">Every two seconds someone needs blood. More than 38,000 blood donations are needed every day. A total of 30 million blood components are transfused each year. Donating blood can help:</p>
        <ul class=" leading-10 text-2xl list-disc ml-14">
        ...
        <p class=" leading-10 text-2xl ml-5">There are also potential benefits for people who regularly donate blood:</p>

        <ul class=" leading-10 text-2xl list-disc ml-14">
          <li><span class="font-bold">Lower iron levels in blood.</span> This is a plus if your iron levels are too high. Donating blood removes some red blood cells, which carry iron throughout your body.</li>
          <li><span class="font-bold">Better cholesterol and triglyceride levels.</span> In one study, researchers checked levels of total cholesterol, triglycerides, HDL (“good”) cholesterol, and LDL (“bad”) cholesterol in 52 people who regularly gave blood and 30 other people. Levels of triglycerides, total, and LDL cholesterol were all lower in those who regularly gave blood. Its not clear why.
          </li>
          <li><span class="font-bold">Emotional benefits </span> from knowing you helped someone else, even if its a stranger. There may also be benefits from taking part in a blood drive with other people from teaming up to do good.
          </li>
        </ul>
      ...
      <section>
        ...
        <span id="benefits" class="text-2xl font-bold text-black flex justify-center ">Eligibility</span>

        <p class=" leading-10 text-2xl ml-5"> If you think you want to donate blood, its important to make sure you meet the requirements and that you properly prepare. Any healthy adult, both male and female, can donate every three months. You'll need to:</p>
        ...
        <section>
          ...
          <span id="benefits" class="text-2xl font-bold text-black flex justify-center ">Procedure</span>

          <h3 class=" ml-10 leading-10 text-2xl font-bold">Before:</h3>
          <p class=" leading-10 text-2xl ml-5"> If you think you want to donate blood, its important to make sure you meet the requirements and that you properly prepare. Any healthy adult, both male and female, can donate every three months. <span class="font-bold">See Eligibility section to know!</span> </p>

          <h3 class=" ml-10 leading-10 text-2xl font-bold">During the Procedure:</h3>

          <p class=" leading-10 text-2xl ml-5"> You lie or sit in a reclining chair with your arm extended on an armrest. If you have a preference for which arm or vein is used, tell the person who is collecting your blood. A blood pressure cuff or tourniquet is placed around your upper arm to fill your veins with more blood. This makes the veins easier to see and easier to insert the needle into. It also helps fill the blood bag more quickly. Then the skin on the inside of your elbow is cleaned. <br>
            ...
            <h3 class=" ml-10 leading-10 text-2xl font-bold">After the Procedure:</h3>

            <p class=" leading-10 text-2xl ml-5">After donating, you sit in an observation area, where you rest and eat a light snack. After 15 minutes, you can leave. After your blood donation:</p>
        <ul class=" leading-10 text-2xl list-disc ml-14">
          ...
          <section>
            ...
            <span id="benefits" class="text-2xl font-bold text-black flex justify-center ">Results</span>
            <h3 class=" ml-10 leading-10 text-2xl font-bold">Testing:</h3>
            <p class=" leading-10 text-2xl ml-5">Your blood will be tested to determine your blood type and your Rh factor. Blood type is classified as A, B, AB or O. The Rh factor refers to the presence or absence of a specific antigen — a substance capable of stimulating an immune response — in the blood. You'll be classified as Rh positive or Rh negative, meaning you do or don't carry the antigen. This information is important because your blood type and Rh factor must be compatible with the blood type and Rh factor of the person receiving your blood.

              Your blood will also be tested for bloodborne diseases, such as hepatitis and HIV. If these tests are negative, the blood is distributed for use in hospitals and clinics. If any of these tests are positive, the donor center notifies you, and your blood is discarded.</p>
